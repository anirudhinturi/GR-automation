...
class InvoiceProcessorGUI:
    ...
    def create_upload_tab(self):
        ...
        # Make the entire drop frame clickable
    ...
    def create_summary_tab(self):
        ...
        export_all_btn = ttk.Button(export_left, text="📑 Export All Data",
        ...
        clear_btn = ttk.Button(export_right, text="🗑️ Clear Data",
    ...
    def create_services_tab(self):
        ...
        self.notebook.add(services_frame, text="🛠️ Service Details")
        ...
        export_services_btn = ttk.Button(export_left, text="🛠️ Export Services",
    ...
    def create_settings_tab(self):
        ...
        save_btn = ttk.Button(settings_content, text="💾 Save Settings", command=self.save_config)
    ...
    def on_services_selection(self, event):
        ...
        if selection:
            ...
            self.status_var.set(f"🛠️ Selected service: {values[1][:50]}...")
    ...
    def export_services_only(self):
        ...
        try:
            ...
            self.status_var.set(f"🛠️ Services exported to: {excel_path}")
    ...
    def export_filtered_services(self):
        ...
        try:
            ...
            self.status_var.set(f"🛠️ Filtered services exported to: {excel_path}")
